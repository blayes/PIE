%dd=1; nsub=20; ndim=4; keys=1:4; dirp='/nfsscratch/Users/ssrivastva/pie/mixef/';
...
for dims = 1:ndim
    subsetPost = {};    
    for jj = 1:nsub
        subsetPost{jj} = bs{jj, dims}(randi([1 500], 200, 1));
    end         
    
    if mod(dims, 2) == 0
        overallPost = linspace(0.8, 1.2, 1000)';        
    else
        overallPost = linspace(-1.2, -0.8, 1000)';        
    end
